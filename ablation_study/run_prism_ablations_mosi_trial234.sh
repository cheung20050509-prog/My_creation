...
# completes. Override JOBS_PER_GPU for multi-job-per-card (not recommended for baseline none).
#
...
#                  Unset: **1 job per GPU** (1,1,…); two GPUs 0,1 → waves of two parallel modes.

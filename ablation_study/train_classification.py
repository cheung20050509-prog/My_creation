...
parser.add_argument("--ablation", type=str, default="none",
                    choices=["none", "no_infogate", "no_mselector", "no_ib",
                             "no_conf_gating", "no_adaptive_gate"],
                    help="Architectural ablation mode.")

# Load best hyperparameters from local hparams.py, keyed by --dataset
from hparams import UR_FUNNY, MUSTARD
_BEST_HPARAMS = {"ur_funny": UR_FUNNY, "mustard": MUSTARD}

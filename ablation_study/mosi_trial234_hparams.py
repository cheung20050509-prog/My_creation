...
Numeric ``TRIAL_234_PARAMS`` / ``format_train_float_argv`` / base ``build_train_argv``
must stay identical to ``fixed_experiment/mosi_trial234_hparams.py`` (mirror there first,

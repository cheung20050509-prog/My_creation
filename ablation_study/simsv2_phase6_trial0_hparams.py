...
Numeric core matches [`fixed_experiment/simsv2_phase6_trial0_hparams.py`](../fixed_experiment/simsv2_phase6_trial0_hparams.py).

Study ``infogate_simsv2_phase6_simsv2_4090d_space3``. Gold train log:

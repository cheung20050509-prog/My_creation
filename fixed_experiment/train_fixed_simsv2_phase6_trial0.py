#!/usr/bin/env python3
"""Launch ``My_creation/fixed_experiment/train.py`` with frozen SIMSv2 phase6 trial 0 hyperparameters."""
...
def main() -> int:
    ...
    ap.add_argument(
        "--checkpoint-dir",
        default=str(my_creation / "fixed_experiment/runs/simsv2_phase6_trial0/checkpoints"),

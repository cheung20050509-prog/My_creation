#!/usr/bin/env python3
"""Launch ``My_creation/train.py`` with frozen MOSEI phase1 trial 70 hyperparameters."""
...
def main() -> int:
    ...
    ap.add_argument(
        "--checkpoint-dir",
        default=str(my_creation / "fixed_experiment/runs/mosei_phase1_trial70/checkpoints"),
    ...
    ap.add_argument(
        ...
        type=int,
        default=None,
        help="Override train.py --seed (default: frozen hparams TRIAL_70_PARAMS['seed'])",
    )
    args = ap.parse_args()

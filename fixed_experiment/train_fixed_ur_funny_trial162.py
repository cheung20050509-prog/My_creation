#!/usr/bin/env python3
"""Launch ``My_creation/train_classify.py`` with frozen UR-FUNNY v2 trial 162 hyperparameters."""
...
def main() -> int:
    ...
    ap.add_argument(
        "--checkpoint-dir",
        default=str(my_creation / "fixed_experiment/runs/ur_funny_trial162/checkpoints"),

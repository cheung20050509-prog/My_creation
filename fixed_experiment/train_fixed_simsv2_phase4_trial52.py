#!/usr/bin/env python3
"""Launch ``My_creation/train.py`` with frozen SIMSv2 phase4 trial 52 hyperparameters."""
...
def main() -> int:
    ...
    ap.add_argument(
        "--checkpoint-dir",
        default=str(my_creation / "fixed_experiment/runs/simsv2_phase4_trial52/checkpoints"),

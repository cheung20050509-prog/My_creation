#!/usr/bin/env python3
"""Verify SIMSv2 phase6_simsv2_space3 trial-0 hyperparameters match ``optuna_search_v2.objective()`` formatting.
...
# Tier 1–3 from phase6 study ``infogate_simsv2_phase6_simsv2_4090d_space3`` trial 0.
TRIAL_0_PARAMS = {
    "n_epochs": 57,
...
def main() -> int:
    ...
    ap.add_argument(
        "--storage",
        default="sqlite:///logs/optuna/4090D_restart/phase6_simsv2/db/simsv2.db",
